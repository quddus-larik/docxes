...
Make your own consistant UI by development code and replace your Theme in `x-meta.config.tsx`.

Explore `marketplace` folder for UI. It have three UI system `CurvedUI, ShadcnUI(default), MinimalUI`,
